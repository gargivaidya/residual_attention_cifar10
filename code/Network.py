...
class ResidualAttentionNetwork(nn.Module):
    ...
    def __init__(self):
        ...
        self.attention_module1 = AttentionModule_stage1(128, 128, size1=(32, 32), size2=(16, 16))  # 32*32
        self.residual_block2 = ResidualBlock(128, 256, 2)  # 16*16
        self.attention_module2 = AttentionModule_stage2(256, 256, size=(16, 16))  # 16*16
        self.attention_module2_2 = AttentionModule_stage2(256, 256, size=(16, 16))  # 16*16 # tbq add
        self.residual_block3 = ResidualBlock(256, 512, 2)  # 4*4
        self.attention_module3 = AttentionModule_stage3(512, 512)  # 8*8
        self.attention_module3_2 = AttentionModule_stage3(512, 512)  # 8*8 # tbq add
        self.attention_module3_3 = AttentionModule_stage3(512, 512)  # 8*8 # tbq add
